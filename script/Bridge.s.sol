...
contract Bridge is Script {
    ...
    function run() external {
        ...
        string memory json = vm.readFile(DEPLOYMENT_INFO_FILE);
        address aidAddress = json.readAddress(".chainA.aid");
        address adapterAddress = json.readAddress(".chainA.adapter");
        uint32 dstEid = uint32(json.readUint(".chainB.eid"));
