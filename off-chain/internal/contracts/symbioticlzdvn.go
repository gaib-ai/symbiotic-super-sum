...
// VerifyWithSymbiotic is a paid mutator transaction binding the contract method 0xaa7da7f1.
//
// Solidity: function verifyWithSymbiotic(bytes _packetHeader, bytes32 _payloadHash, uint64 _confirmations, uint48 _epoch, bytes _proof) returns()
func (_SymbioticLzDVN *SymbioticLzDVNTransactor) VerifyWithSymbiotic(opts *bind.TransactOpts, _packetHeader []byte, _payloadHash [32]byte, _confirmations uint64, _epoch *big.Int, _proof []byte) (*types.Transaction, error) {
	return _SymbioticLzDVN.contract.Transact(opts, "verifyWithSymbiotic", _packetHeader, _payloadHash, _confirmations, _epoch, _proof)
}

// VerifyWithSymbiotic is a paid mutator transaction binding the contract method 0xaa7da7f1.
//
// Solidity: function verifyWithSymbiotic(bytes _packetHeader, bytes32 _payloadHash, uint64 _confirmations, uint48 _epoch, bytes _proof) returns()
func (_SymbioticLzDVN *SymbioticLzDVNSession) VerifyWithSymbiotic(_packetHeader []byte, _payloadHash [32]byte, _confirmations uint64, _epoch *big.Int, _proof []byte) (*types.Transaction, error) {
	return _SymbioticLzDVN.Contract.VerifyWithSymbiotic(&_SymbioticLzDVN.TransactOpts, _packetHeader, _payloadHash, _confirmations, _epoch, _proof)
}

// VerifyWithSymbiotic is a paid mutator transaction binding the contract method 0xaa7da7f1.
//
// Solidity: function verifyWithSymbiotic(bytes _packetHeader, bytes32 _payloadHash, uint64 _confirmations, uint48 _epoch, bytes _proof) returns()
func (_SymbioticLzDVN *SymbioticLzDVNTransactorSession) VerifyWithSymbiotic(_packetHeader []byte, _payloadHash [32]byte, _confirmations uint64, _epoch *big.Int, _proof []byte) (*types.Transaction, error) {
	return _SymbioticLzDVN.Contract.VerifyWithSymbiotic(&_SymbioticLzDVN.TransactOpts, _packetHeader, _payloadHash, _confirmations, _epoch, _proof)
}
